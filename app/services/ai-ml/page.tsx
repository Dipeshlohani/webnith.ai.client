...
import { aimlHeroData, aimlWhyData, aimlProcessData, aimlServicesData } from '../../data/ai-ml'
  ...
  return (
    <>
      ...
      <section className="section-sm">
        <div className="container">
          <div className="text-center mb-16">
            ...
            >
              <span className="gradient-text">Our AI & ML Services</span>
            </motion.h2>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {aimlServicesData.map((service, index) => (
              <motion.div
                key={index}
      ...
      <ProcessSection
        ...
        subtitle="A systematic approach to building intelligent solutions."
        steps={aimlProcessData}
      />
